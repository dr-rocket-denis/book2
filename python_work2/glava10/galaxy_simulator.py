...
def main():
    ...
    c.create_text(-455, -360, fill='white', anchor='w',text='Один Пиксель = {} LY'.format(SCALE))
    c.create_text(-455, -330, fill='white', anchor='w', text='Диаметр радиопузырька = {} LY'.format(SCALE))
    ...
    if SCALE == 225:
        ...
        c.create_text(118, 72, fill='red', anchor='w', text="<---------- Земной радиопузырь")
    root.mainloop()
